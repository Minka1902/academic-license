...
export default function LoginPopup(props) {
  ...
  const { linkText, isOpen, handleSwitchPopup, isFound, handleLogin, onClose, buttonText = 'Submit', onSignOut, isCloseButton = false } = props;
  ...
  return (
    <>
      {!currentUser ?
        <PopupWithForm onSubmit={handleSubmit} isValid={isValid} handleSwitchPopup={handleSwitchPopup} isCloseButton={isCloseButton} linkText={linkText} name="login" title="Sign in" isOpen={isOpen} onClose={onClose} buttonText={buttonText}>
